...
<body>
    <div class="hero-section">
        <div class="container">
            <div class="row">
			<a href="index.html" class="logo"><img src="images/logo.png" alt="Brigitte Lardet Coiffure à Lens"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            <!-- newsletter block -->
                            <h2 class="widget-title">Développement par</h2>
                            <ul class="listnone contact">
                                <li><i class="fa fa-user"></i> Benoit Delobel </li>
                                <li><i class="fa fa-phone"></i> 06.41.87.84.10</li>
                                <li><i class="fa fa-envelope-o"></i>devunity62400@gmail.com</li>
                            </ul>
                            <!-- /input-group -->
                        </div>
                        <!-- newsletter block -->
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© Brigitte Lardet Coiffure | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
